...
test_Bscan_cpu:
		python src/processing/Bscan.py --silent -d=1 -if=data/Bscan/example.npy -c=data/calibration/example/calib.json

test_Bscan_gpu:
		python src/processing/Bscan.py --silent -gpu -d=1 -if=data/Bscan/example.npy -c=data/calibration/example/calib.json
